...
# 代码使用：python teacher_classification_terminal_parameter_transmission_version.py --data data/original_data/test.xlsx --config config/config.json --prompt prompt/prompt1老师四分类.txt --output output.xlsx
